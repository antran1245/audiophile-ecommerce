        ...
        <main>
            ...
            */}
            <section className='flex justify-center mt-[120px] xs:mt-0'>
                <div className={`flex flex-row xs:flex-col w-[70%] lg:w-[90%] items-end`}>
                    <div className='w-[30%] lg:w-[33%] xs:w-full h-[284px] lg:h-[217px] m-auto flex flex-col items-center relative'>
                        <img src={headphones} alt="headphones" className='w-[60%] xs:w-[40%] sm:w-[90%] lg:w-[50%] xs:mt-[10px] relative z-[2]'/>
                    ...
                    <div className='w-[30%] lg:w-[33%] xs:w-full h-[284px] lg:h-[217px] m-auto flex flex-col items-center relative'>
                        <img src={speakers} alt="speakers" className='w-[60%] xs:w-[40%] sm:w-[90%] lg:w-[50%] xs:mt-[10px] relative z-[2]'/>
                        <div className='h-[204px] lg:h-[165px] w-full bg-F1F1F1 rounded-[8px] flex justify-end items-center flex-col absolute bottom-0'>
                    ...
                    <div className='w-[30%] lg:w-[33%] xs:w-full h-[284px] lg:h-[217px] m-auto flex flex-col items-center relative'>
                        <img src={earphones} alt="earphones" className='w-[60%] xs:w-[40%] sm:w-[90%] lg:w-[50%] xs:mt-[10px] relative z-[2]'/>
                        <div className='h-[204px] lg:h-[165px] w-full bg-F1F1F1 rounded-[8px] flex justify-end items-center flex-col absolute bottom-0'>
